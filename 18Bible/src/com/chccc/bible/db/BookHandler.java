...
//    	create( new BookDTO("使徒行传", "", "44"));
//    	create( new BookDTO("罗马书", "", "45"));
//    	create( new BookDTO("哥林多前书", "", "46"));
//    	create( new BookDTO("哥林多后书", "", "47"));
//    	create( new BookDTO("加拉太书", "", "48"));
//    	create( new BookDTO("以弗所书", "", "49"));
//    	create( new BookDTO("腓立比书", "", "50"));
//    	create( new BookDTO("歌罗西书", "", "51"));
//    	create( new BookDTO("帖撒罗尼加前书", "", "52"));
//    	create( new BookDTO("帖撒罗尼加后书", "", "53"));
//    	create( new BookDTO("提摩太前书", "", "54"));
//    	create( new BookDTO("提摩太后书", "", "55"));
//    	create( new BookDTO("提多书", "", "56"));
//    	create( new BookDTO("腓立门书", "", "57"));
//    	create( new BookDTO("希伯来书", "", "58"));
//    	create( new BookDTO("雅各书", "", "59"));
//    	create( new BookDTO("彼得前书", "", "60"));
//    	create( new BookDTO("彼得后书", "", "61"));
//    	create( new BookDTO("约翰一书", "", "62"));
//    	create( new BookDTO("约翰二书", "", "63"));
//    	create( new BookDTO("约翰三书", "", "64"));
//    	create( new BookDTO("犹大书", "", "65"));
//    	create( new BookDTO("启示录", "", "66"));
//    }
//    
    /*
